...
bool db_1_tremove_by_index(pool_mg_s*, disk_mg_s*, char*, int, bool);
bool db_1_trearrange(pool_mg_s*, disk_mg_s*, char*);
char* db_1_tschema(pool_mg_s*, disk_mg_s*, int, char*);
void db_1_show_distribute(pool_mg_s*, disk_mg_s*, char*);
