...
void db_1_iinsert(pool_mg_s*, disk_mg_s*, char*, char*, int);
void db_1_iremove_by_pkey(pool_mg_s*, disk_mg_s*, char*, int);
void db_1_isearch_by_pkey(pool_mg_s*, disk_mg_s*, char*, int);
